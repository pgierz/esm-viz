...
### Solid Earth:
{}
""".format(expid=self.expid, 
                                        setup=self.setup.upper(),
                                        *[component._repr_markdown_() if hasattr(component, "_repr_markdown_") else component for component in self.components])
...
""".format(a=a, model=self.__name__.upper(), data_loaded=self._data_loaded)
